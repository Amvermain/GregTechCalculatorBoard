...
- Create 모드 증기 보일러의 가열 레벨(패시브 / 1~18 레벨) 설정 및 물/증기 유체 모드 전환 기능을 추가하여, 보일러의 회전력 생산량을 최대 294k SU까지 자유롭게 조절할 수 있도록 개선했습니다.
...
- **폐순환 루프 발산 방어 경고 뱃지 및 인터랙티브 해결 가이드 추가**:
  - 외부 원료 공급이 부족한 폐순환 루프(예: 오일 크래킹, 탈황 등)에서 자동 비율 맞춤 실행 시 기계 대수가 무한히 증폭되는 현상을 안전하게 방어하고, 해당 기계 카드에 `[⚠️ 루프]` 경고 뱃지를 표시하도록 개선했습니다.
...
- **상황별 공정 불안정 경고 뱃지 및 진단 가이드 추가**:
  - 자원 증식 루프(`[⚠️ 증식]`), 촉매 감쇠 루프(`[⚠️ 촉매]`), 복수 앵커 충돌(`[⚠️ 충돌]`), 극미세 수율 레시피(`[⚠️ 극소]`) 등 다양한 공정 발산 상황에 맞춘 전용 경고 뱃지를 추가했습니다.
