...
public enum TutorialStep {
    ...
    STEP_5_MACHINE_SELECTOR(5, "gui.gtcalcboard.tutorial.step5_selector_title", "gui.gtcalcboard.tutorial.step5_selector_desc"),
    STEP_6_MACHINE_CONFIG(6, "gui.gtcalcboard.tutorial.step5_title", "gui.gtcalcboard.tutorial.step5_desc"),
    STEP_7_GROUP_FRAME(7, "gui.gtcalcboard.tutorial.step6_title", "gui.gtcalcboard.tutorial.step6_desc"),
