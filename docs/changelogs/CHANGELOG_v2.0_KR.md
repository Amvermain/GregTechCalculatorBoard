...
<p align="center">
  <a href="CHANGELOG_v2.0.md">English</a> | <b>한국어</b>
</p>
...
- **핵융합로 최소 요구 티어 컨트롤러 자동 매칭 (`GTCEuModAdapter`, `GTAddonCompatibilityHandler`, `EmiRecipeConverter`, `JeiRecipeConverter`)**:
  - 핵융합로(Mk1, Mk2, Mk3) 레시피를 보드에 추가할 때, 레시피의 최소 요구 전압 티어(예: 180M EU -> ZPM Mk2)와 정확히 일치하는 컨트롤러 머신 아이콘이 기본값으로 우선 선택 및 지정되도록 지원.
