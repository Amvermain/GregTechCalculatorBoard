...
| **[ADR-007](ADR_007_HIERARCHICAL_PAGE_EXPLORER_AND_MACHINE_TEMPLATES.md)** | 계층형 폴더블 페이지 탐색기 및 머신 하드웨어 템플릿 시스템<br/>*(Hierarchical Foldable Page Explorer & Machine Setup Templates)* | 🟢 `IMPLEMENTED` | `v2.2.0` | 2026-09-02 | 다층 폴더 트리 사이드바(`PageBrowserDrawer`), 실시간 검색, `Ctrl+K` 퀵 스위처, 기계 하드웨어 스펙 보존형 원클릭 레시피 복제/교체 시스템 |
