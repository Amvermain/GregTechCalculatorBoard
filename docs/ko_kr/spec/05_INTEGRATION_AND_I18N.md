...
| `compat.createdieselgenerators` | `CreateDieselGeneratorsModAdapter`<br/>`CDGRecipeHandler` | • 디젤 엔진 3종(기본/모듈러/대형) 회전력(SU) 발전 및 유체 연료 소비 시뮬레이션<br/>• 대야 가공(발효) 및 원유 분별 증류탑, 압축 성형 레시피 연동 |
