...
<p align="center">
  <a href="../en_us/ARCHITECTURE.md">English</a> | <b>한국어</b>
</p>
...
> 📑 **세부 사양서 바로가기**:
> * [[00] 시스템 아키텍처 개요](spec/00_OVERVIEW.md)
> * [[01] 코어 도메인 모델](spec/01_CORE_DOMAIN_AND_MODELS.md)
> * [[02] 수학 엔진 및 알고리즘](spec/02_MATH_AND_ALGORITHMS.md)
> * [[03] UI 및 렌더링 파이프라인](spec/03_UI_AND_RENDERING_PIPELINE.md)
> * [[04] 멀티플레이어 및 네트워크](spec/04_MULTIPLAYER_AND_NETWORK_PROTOCOL.md)
> * [[05] 외부 연동 및 다국어](spec/05_INTEGRATION_AND_I18N.md)