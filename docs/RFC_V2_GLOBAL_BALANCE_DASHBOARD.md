...
### 1.2 목표
1. **다중 페이지 선택 기반 통합 집계**: 원하는 페이지들을 체크박스로 선택하여 전 기지 통합 대차대조표를 실시간 계산.
...
```mermaid
graph TD
    subgraph SelectedPages ["선택된 페이지 목록"]
